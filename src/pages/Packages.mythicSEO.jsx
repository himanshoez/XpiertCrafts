...
{/* Overlay layer */}
    ...
    <div className="content relative z-10">
      <h1 className='text-xl md:text-5xl py-5 text-center'>Mythic SEO</h1>
      <p className='text-md py-5 opacity-100 md:w-11/12 mx-3 md:mx-auto text-[#292929]' >Home/Mythic SEO</p>
    </div>
    </header>
    ...
    <div className="card flex md:flex-row flex-col md:w-11/12 my-10 md:my-28 mx-4 gap-10 md:mx-auto justify-around">
        ...
        <h1 className='text-[16px] md:text-3xl w-full my-2 md:leading-10' >About Mythic SEO</h1>
        <summary className='text-[12px] md:text-[18px] text-[#4a4a4a] list-none w-full my-5 md:leading-10'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium in voluptatibus facilis placeat impedit, ea quia similique dolor nostrum, voluptates ipsa ducimus, maxime vel?
        </summary>
        </div>
